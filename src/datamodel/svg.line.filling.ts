...
import {scale, clipFilling, DrawInitials, Progression, createFillingElements, add, rotate, subtract, getBoundingBox} from './svg.filler'
import {ClipUtils} from './svg.clipping'

export function createSimpleLineFilling(filledElement: ModelElement, angle: number, spacing: number, offset: number): ModelElement[] {
    /*
